...
| `SGLANG_DIFFUSION_BRANCH` | `sglang-miles` | sglang branch the rollout engine is built from; carries upstream `main` plus the diffusion rollouts this repo needs ahead of it. |
