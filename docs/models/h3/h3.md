...
| Timestep scaling | Off, `sde_timestep_divisor = 1000.0` | The DiT conditions on `1 - sigma`, so the recorded timestep is divided back down |
...
# short train
python3 scripts/run_diffusion_grpo_h3_t2va_2gpu.py --num-rollout 5 --eval-interval 0
