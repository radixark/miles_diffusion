...
run torchrun --standalone --nproc_per_node=4 tests/sp/sp_init_smoke.py --sp 4 --ulysses 2
...
run torchrun --standalone --nproc_per_node=4 tests/sp/sp_attention_parity.py --sp 4 --ulysses 2
run torchrun --standalone --nproc_per_node=4 tests/sp/sp_attention_parity.py --sp 4 --ulysses 2 --ckpt
...
run torchrun --standalone --nproc_per_node=4 tests/sp/sp_grad_sync_parity.py --shard-mode dp_sp --sp 4 --ulysses 2
...
run torchrun --standalone --nproc_per_node=4 tests/sp/sp_weight_sync_parity.py --sp 4 --ulysses 2 --shard-mode dp
run torchrun --standalone --nproc_per_node=4 tests/sp/sp_weight_sync_parity.py --sp 4 --ulysses 2

export CUBLAS_WORKSPACE_CONFIG=:4096:8
run torchrun --standalone --nproc_per_node=2 tests/sp/sp_determinism_smoke.py --sp 2 --ulysses 2
run torchrun --standalone --nproc_per_node=2 tests/sp/sp_determinism_smoke.py --sp 2 --ulysses 1
